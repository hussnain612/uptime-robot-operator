...
func init() {
	...
	utilruntime.Must(uptimev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "edacd391.uptime.com",
	...
	if err = (&uptimev1alpha1.Monitor{}).SetupWebhookWithManager(mgr); err != nil {
